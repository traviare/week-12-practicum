...
const makeFive = () => {
	...
	const power = 4;
	//Ваш код
	resultFive.textContent = Math.pow(3, 4);
};
...
const makeSixteen = () => {
	const str = 'JavaScript';
	//Ваш код
	resultSixteen.textContent = str.substring(3, 10);
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	//Ваш код
	resultSeventeen.textContent = str.substring(3, 6);
};
...
const makeEighteen = () => {
	...
	//Ваш код
	resultEighteen.textContent = str.replace(/world/i, 'JavaScript');
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	//Ваш код
	resultNineteen.textContent = str.substring(7, 13);
};
